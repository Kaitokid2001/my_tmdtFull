  ...
  return (
    <NavbarMenuHidden>
      ...
      <SidebarMenu $open={checked}>
          ...
          <SidebarMenuLi>
            ...
            <ContentDiv hidden={!openMenuItem1}>
              <ItemList>
                ...
                >
                  {t("menu.electronicComponents.heatSink")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.electronicComponents.power")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
          ...
          <SidebarMenuLi>
            ...
            <ContentDiv hidden={!openMenuItem4}>
              <ItemList>
                ...
                >
                  {t("menu.gamingGear.keyboardGaming")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.gamingGear.keyboardOffice")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.gamingGear.wirelessHeadphones")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.gamingGear.wiredHeadphones")}
                </Item>
              </ItemList>
            </ContentDiv>
          </SidebarMenuLi>
          <SidebarMenuLi>
            ...
            <ContentDiv hidden={!openMenuItem5}>
              <ItemList>
                ...
                >
                  {t("menu.tableChair.chairErgonomic")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.tableChair.tableLifting")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.tableChair.T-shapedDesk")}
                </Item>
              </ItemList>
            </ContentDiv>
          </SidebarMenuLi>
          <SidebarMenuLi>
            ...
            <ContentDiv hidden={!openMenuItem6}>
              <ItemList>
                ...
                >
                  {t("menu.accessory.accessoryLaptop")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.accessory.accessoryHeatSink")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.accessory.accessoryGear")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.accessory.accessoryScreen")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
                ...
                >
                  {t("menu.accessory.accessoryVGA&PSU")}
                </Item>
                <Item
                  href="/product"
                  onClick={() => {
        ...
        <FooterMenuSidebar>
          <p>Version &copy; {currentYear} recommend</p>
        </FooterMenuSidebar>
      </SidebarMenu>
    </NavbarMenuHidden>
  );
